...
internal class UpdateHandlerService : IUpdateHandler
{
    ...
    async Task<Message> Usage(Message msg)
    {
        ...
        //    📍 /request         - локация или контакт
        //    🔎 /inline_mode     - inline-режим
        //    📊 /poll            - создать опрос
        ...
        return await _botClient.SendMessage(msg.Chat, $"{msg.From} said: {msg.Text}", parseMode: ParseMode.Html, replyMarkup: new ReplyKeyboardRemove());
    }
